...
with st.sidebar: 
    selected = option_menu('Poly-Patho-Prognosis',
                           ...
                           icons=['activity', 'heart','lungs', 'clipboard2-heart','person','pen-fill'],
                           default_index=0)
...
if selected == 'Diabetes Prediction':
    ...
    csv_file_path = "C:/Users/dcdha/OneDrive/Desktop/Final/Diabetes Data Collection.csv"
    ...
    if submit_button:
        ...
        st.write("YOUR DATA HAS BEEN SAVED. YOUR DATA IS SAFE WITH US AND ONLY MIGHT BE USED FOR ANALYSIS PURPOSE. WE ARE HIGHLY GREATFUL FOR YOUR AMAZING CONTRIBUTION TOWARDS MANKIND.")
...
if selected == 'Heart Attack Prediction':
    ...
    #Data Collection
    csv_file_path = "C:/Users/dcdha/OneDrive/Desktop/Final/Heart Attack Data Collection.csv"
...
if selected == "Lung Cancer Prediction":
    ...
    if submit_button:
        ...
        user_input = [index	, Age, Gender,	AirPollution,	Alcoholuse, DustAllergy, OccuPationalHazards, GeneticRisk, chronicLungDisease, BalancedDiet,
                      Obesity, Smoking, PassiveSmoker, ChestPain	, CoughingofBlood,	Fatigue, WeightLoss, ShortnessofBreath, Wheezing, SwallowingDifficulty,	
    ...
    csv_file_path = "C:/Users/dcdha/OneDrive/Desktop/Final/Lung Cancer Data Collection.csv"
    data = pd.DataFrame(columns=["index",	"Patient Id",	"Age",	"Gender",	"Air Pollution",	"Alcohol use",	"Dust Allergy",	"OccuPational Hazards",	"Genetic Risk",
                                 "Chronic Lung Disease",	"Balanced Diet",	"Obesity",	"Smoking",	"Passive Smoker",	"Chest Pain",	"Coughing of Blood",
                                 "Fatigue",	"Weight Loss",	"Shortness of Breath",	"Wheezing",	"Swal0ing Difficulty",	"Clubbing of Finger Nails",	"Frequent Cold",
...
if selected == "Hepatitis Prediction":
    ...
    with col2:
        Headache = st.text_input('Headache: [Absent=1], [Present=2]')
...
if selected == "Parkinson's Prediction":
    ...
    csv_file_path = "C:/Users/dcdha/OneDrive/Desktop/Final/Parkinson Data Collection.csv"
...
if selected =="More":
    ...
    def main():
        ...
        st.title('Mission & Vision') # Page title
        ...
        with st.sidebar: 
            selected = option_menu('Poly-Patho-Prognosis',
                                   ['Mission', 'Vision'],
                                   menu_icon='hospital-fill',
                                   icons=['lightning-charge-fill', 'eye-fill'],
                                   default_index=0)
    
        # Displaying content based on selected option
        if selected == 'Mission':
            st.header('Mission Statement:')
            st.markdown("""
            <span style="color: #008080; font-size: 18px; font-weight: bold;"> To develop an AI-powered multiple disease prediction system that utilizes machine learning algorithms to analyze various health parameters and provide accurate predictions for a range of diseases. Our mission is to empower healthcare professionals with a powerful tool that can assist in early diagnosis, improving treatment outcomes, and ultimately saving lives.</span>
            """,unsafe_allow_html=True)
            st.write("""
                <span style="color: white; font-size: 28px; font-weight: bold;">Key Objectives:</span>""", unsafe_allow_html=True)
            st.write("""
        <span style="color: white; font-size: 28px; font-weight: bold;">Data Collection and Integration:</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Gather diverse datasets including patient health records, medical imaging data, genetic information, lifestyle factors, and environmental data.</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Integrate and preprocess the data to ensure consistency and accuracy.</span>

        <span style="color: white; font-size: 28px; font-weight: bold;">Algorithm Development:</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Develop machine learning algorithms capable of analyzing diverse datasets for multiple diseases.</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Implement state-of-the-art techniques for feature selection, dimensionality reduction, and model training.</span>

        <span style="color: white; font-size: 28px; font-weight: bold;">Model Validation and Evaluation:</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Validate models using cross-validation techniques and independent test datasets.</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Evaluate model performance using appropriate metrics such as accuracy, sensitivity, specificity, and area under the ROC curve.</span>

        <span style="color: white; font-size: 28px; font-weight: bold;">System Integration:</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Build a user-friendly interface for healthcare professionals to interact with the system.</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Ensure scalability and reliability of the system.</span>

        <span style="color: white; font-size: 28px; font-weight: bold;">Ethical Considerations:</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Ensure patient data privacy and compliance with regulations such as HIPAA and GDPR.</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Implement transparency and fairness in the prediction models.</span>

        <span style="color: white; font-size: 28px; font-weight: bold;">Clinical Validation:</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Conduct clinical studies to validate the system's effectiveness in real-world settings.</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Collaborate with healthcare institutions for real-world testing and feedback.</span>

        <span style="color: white; font-size: 28px; font-weight: bold;">Continuous Improvement:</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Implement mechanisms for continuous learning and improvement of the prediction models.</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Incorporate user feedback and emerging research findings into the system.</span>

        <span style="color: white; font-size: 28px; font-weight: bold;">Target Diseases:</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Cancer (various types)</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Cardiovascular diseases</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Diabetes</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Neurological disorders (e.g., Alzheimer's, Parkinson's)</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Respiratory diseases</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Infectious diseases (e.g., COVID-19, influenza)</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Autoimmune diseases</span>

        <span style="color: white; font-size: 28px; font-weight: bold;">Stakeholders:</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Healthcare professionals (doctors, nurses, researchers)</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Patients</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Healthcare institutions</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Regulatory authorities</span>

        <span style="color: white; font-size: 28px; font-weight: bold;">Impact:</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Early disease detection and intervention</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Improved treatment outcomes</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Reduced Healthcare costs</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Enhanced patient care and quality of life</span>

        <span style="color: white; font-size: 28px; font-weight: bold;">Metrics for Success:</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Accuracy of disease predictions</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Reduction in false positives and false negatives</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Adoption rate among healthcare professionals</span>
          - <span style="color: #008080; font-size: 18px; font-weight: bold;">Patient outcomes and satisfaction</span>

        <span style="color: white; font-size: 18px; font-weight: bold;">By following these steps and objectives, we aim to develop a robust and reliable multiple disease prediction system that can revolutionize healthcare and save lives.</span>
        """, unsafe_allow_html=True)
            
            
        if selected == 'Vision':
            st.header('Vision Statement:', 'bold')
            st.markdown("""
            <span style="color: #008080; font-size: 18px; font-weight: bold;">Our vision is to revolutionize healthcare by developing an advanced multiple disease prediction system that harnesses the power of artificial intelligence and machine learning. Our system will integrate diverse data sources including electronic health records, genetic information, lifestyle factors, environmental data, and real-time health monitoring devices.</span>
    
            <span style="color: #008080; font-size: 18px; font-weight: bold;">Through sophisticated data analysis and predictive modeling, our system will accurately assess an individual's risk of developing various diseases such as diabetes, heart disease, cancer, and more. By providing early detection and personalized risk assessment, our system will empower individuals to take proactive steps towards prevention, lifestyle modifications, and timely medical interventions.</span>
    
            <span style="color: #008080; font-size: 18px; font-weight: bold;">Furthermore, our system will enable healthcare providers to deliver more targeted and effective care by identifying high-risk patients and implementing preventive measures at an early stage. By facilitating early intervention and personalized healthcare, our system aims to improve health outcomes, reduce healthcare costs, and enhance overall well-being on a global scale.</span>
            """, unsafe_allow_html=True)
